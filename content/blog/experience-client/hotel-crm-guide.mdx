...
<KeyFiguresGrid>
  <KeyFigureCard statId="avgBasket" label="Average basket" />
  <KeyFigureCard statId="googleReviews" label="Google reviews" />
  <KeyFigureCard statId="hoursSaved" label="Saved per team" />
</KeyFiguresGrid>
...
<Callout type="info">
TriggerFlow is used by **<Stat id="hotels" /> hotels** and rated **<Stat id="rating" />** by the hoteliers who use it — and a CRM only pays off when teams actually adopt it day to day.
</Callout>
