  ...
  return (
    <BrowserMockup title="Workflow Builder" className="max-w-lg">
      <div className="flex min-h-[300px]">
        ...
        {/* Canvas area */}
        <div className="flex-1 p-4 bg-[#fafbfc] relative overflow-hidden">
...
function CanvasNode({
  ...
  return (
    <div className={`${s.bg} border ${s.border} rounded-xl px-3 py-2 flex items-center gap-2 shadow-sm relative group max-w-[260px]`}>
