...
interface CrmClientCardMockupProps {
  clientName?: string;
...
export function CrmClientCardMockup({
  ...
  clientEmail,
  hotelName,
}: CrmClientCardMockupProps = {}) {
  return (
    <BrowserMockup title="Fiche Client" className="max-w-lg">
      <div className="p-4 min-h-[300px]">
        {hotelName && (
          <div className="flex items-center justify-between border-b border-gray-100 pb-2 mb-3">
            <span className="text-[10px] font-semibold text-gray-600">{hotelName}</span>
            <span className="text-[9px] text-gray-400">Fiche client</span>
          </div>
        )}
        {/* Client header */}
        <div className="flex items-start gap-3 mb-4">
          <div className="w-12 h-12 rounded-full bg-brand-primary/10 flex items-center justify-center flex-shrink-0">
            <span className="text-sm font-bold text-brand-primary">{clientInitials}</span>
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-0.5">
              <h4 className="text-sm font-semibold text-gray-800">{clientName}</h4>
            ...
            <p className="text-[10px] text-gray-500">12 séjours depuis 2021</p>
            {clientEmail && <p className="text-[10px] text-gray-400">{clientEmail}</p>}
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          ...
          <div className="bg-gray-50 rounded-xl p-2.5 text-center">
            ...
            <p className="text-[10px] text-gray-500">Dernier séjour</p>
          </div>
          <div className="bg-gray-50 rounded-xl p-2.5 text-center">
        ...
        {/* Preferences */}
        <div className="mb-4">
          <p className="text-[10px] font-semibold text-gray-600 uppercase tracking-wide mb-2">Préférences</p>
          <div className="flex flex-wrap gap-1.5">
            <PreferenceBadge icon={Heart} label="Oreiller ferme" />
            <PreferenceBadge icon={Waves} label="Vue mer" />
            <PreferenceBadge icon={Building} label="Étage élevé" />
        ...
        {/* Recent stays */}
        <div className="mb-4">
          <p className="text-[10px] font-semibold text-gray-600 uppercase tracking-wide mb-2">Séjours récents</p>
          <div className="space-y-1.5">
            <StayRow date="12-15 jan 2026" room="Suite Deluxe" amount="1 280 EUR" />
            <StayRow date="03-06 nov 2025" room="Chambre Supérieure" amount="720 EUR" />
            <StayRow date="18-22 août 2025" room="Suite Junior" amount="1 560 EUR" />
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-gray-700">Confirmation séjour</p>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-medium text-gray-700">Code WiFi envoyé</p>
                <p className="text-[9px] text-gray-400">Il y a 2 mois</p>
              </div>
              <span className="text-[9px] text-green-600 font-medium">Délivré</span>
            </div>
          </div>
        </div>
      </div>
