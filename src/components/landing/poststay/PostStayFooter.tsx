 ...
 *
 * Le rembourrage bas laisse la place à la barre collante, qui recouvre
 * autrement les liens légaux sur mobile.
 */
export function PostStayFooter({ locale }: { locale: string }) {
  const t = useTranslations('lpPostStay.footer');
